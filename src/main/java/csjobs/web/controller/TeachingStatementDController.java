...
@Controller
public class TeachingStatementDController {
	@Autowired
	...
	public File getFileDirectory(Application application,HttpSession session)
	{
		...
		String path=context.getRealPath("/WEB-INF/files/"+appEmail+"/"+jobTitle+"/TeachingStatement/"+application.getTeachingStatement().getName());
		...
		String PATH=context.getRealPath("/WEB-INF/files/"+appEmail+"/"+jobTitle+"/TeachingStatement");
	...
	@RequestMapping(value="/application/TeachingStatementDownload.html")
